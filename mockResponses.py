...
active_mock_set_config = config_loader.load_mock_set("mitm_" + mock_global_config.active_mock_set)
active_mocks = []
...
def reload_mock_config_if_needed():
    ...
    if active_set_config_needs_update:
        ...
        active_mock_set_config = config_loader.load_mock_set("mitm_" + mock_global_config.active_mock_set)
    elif not mock_global_config.active_mock_set:
        print("No mock set selected\n")
        active_mock_set_config = config_loader.MockSetConfig(None, None, {}, [])
        active_mocks = []
        return
    else:
        return
